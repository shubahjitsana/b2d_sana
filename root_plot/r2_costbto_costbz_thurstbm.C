void r2_costbto_costbz_thurstbm(){
    TFile *fa = new TFile("all.root");
    TTree *ta = (TTree*)fa->Get("tree");
    TFile *fch = new TFile("charged.root");
    TTree *tch = (TTree*)fch->Get("tree");
    TFile *fm = new TFile("mixed.root");
    TTree *tm = (TTree*)fm->Get("tree");
    TFile *fu = new TFile("uubar.root");
    TTree *tu = (TTree*)fu->Get("tree");
    TFile *fd = new TFile("ddbar.root");
    TTree *td = (TTree*)fd->Get("tree");
    TFile *fs = new TFile("ssbar.root");
    TTree *ts = (TTree*)fs->Get("tree");
    TFile *fc = new TFile("ccbar.root");
    ...
    c->Print("r2_costbto_costbz_thurstbm.pdf");
}